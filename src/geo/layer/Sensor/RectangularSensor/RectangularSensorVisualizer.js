...
import AssociativeArray  from "../../../../../cesium/Source/Core/AssociativeArray.js";
...
import MaterialProperty  from "../../../../../cesium/Source/DataSources/MaterialProperty.js";
...
RectangularSensorVisualizer.prototype.update = function (time) {
    ...
    for (var i = 0, len = entities.length; i < len; i++) {
        ...
        if (defined(gaze)) {
            ...
            var rotate = Cartesian3.angleBetween(Cartesian3.UNIT_Z, diffVector);
            var cross = Cartesian3.cross(Cartesian3.UNIT_Z, diffVector, diffVectorScratch);
